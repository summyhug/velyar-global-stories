    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-md mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <h1 className="text-xl font-medium text-foreground">mission hub</h1>
        </div>
      </header>
      ...
      <main className="max-w-md mx-auto px-4 pb-8">
        ...
        <Card className="mt-6 bg-velyar-glow/20 border-velyar-earth/20">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-velyar-earth">global balance needed</span>
            </div>
        ...
        <section className="mt-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-medium text-foreground">active missions</h2>
        ...
        <section className="mt-8">
          <Card className="bg-card border-0 shadow-gentle">
            <CardContent className="p-6">
              <h3 className="text-sm font-medium text-foreground mb-4">this week's impact</h3>
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-lg font-medium text-velyar-earth">3,216</div>
                  <div className="text-xs text-muted-foreground">stories shared</div>
                </div>
                <div>
                  <div className="text-lg font-medium text-velyar-earth">147</div>
                  <div className="text-xs text-muted-foreground">countries</div>
                </div>
                <div>
                  <div className="text-lg font-medium text-velyar-earth">12</div>
